...
public:
	...
	// Accessor function for initial power level
	UFUNCTION(BlueprintPure, Category = "Power")
	float GetInitialPower();

	// Accessor function for current power level
	UFUNCTION(BlueprintPure, Category = "Power")
	float GetCurrentPower();

	/** Function to update the characters power
	* @param PowerCharge This is the amount to change the power by, and it can be positive or negative
	*/
...
protected:
	...
	// The starting power of our character
	UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = "Power", Meta = (BlueprintProtected = "true"))
	float InitialPower;

	// Multiplier for characters speed
	UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = "Power", Meta = (BlueprintProtected = "true"))
	float SpeedFactor;
